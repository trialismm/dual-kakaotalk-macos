...
diagnostic hardware_model "$(/usr/sbin/sysctl -n hw.model 2>/dev/null || printf unknown)"
diagnostic cpu_brand "$(/usr/sbin/sysctl -n machdep.cpu.brand_string 2>/dev/null || printf unknown)"
