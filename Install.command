...
INSTALLER_VERSION="0.1.0-beta.16"
PHASE="bootstrap"
FAILURE_RECORDED=0
ICON=""
...
if [[ "$LANG_CODE" == ko* ]]; then
  ...
  ARM_WARNING="Apple Silicon은 M3/macOS 26.5.2에서 검증했습니다. 다른 칩·macOS 조합에서는 실험적으로 동작합니다."
  ...
  ARM_WARNING="Apple Silicon is verified on M3/macOS 26.5.2. Other chip and macOS combinations remain experimental."
